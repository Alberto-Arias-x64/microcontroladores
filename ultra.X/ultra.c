...
//        
    ...
    // Respecto al sensor
                if(PORTBbits.RB2 == 1 ){CS1++;}
                if(PORTBbits.RB1 == 1 ){CS2++;}
                if(PORTBbits.RB0 == 1 ){CS3++;}
            }
        }
        T0CONbits.TMR0ON = 0; // Apaga el timer
        
        if(CS1>2 && CS1< 10){LATBbits.LATB7 =1;}
        else{LATBbits.LATB7 =0;}
        
        if(CS2>2 && CS2< 10){LATBbits.LATB6 =1;}
        else{LATBbits.LATB6 =0;}
        
        LATA=0;
        if(CS2>2){LATAbits.LATA0 = 1;}
        if(CS2>4){LATAbits.LATA1 = 1;}
        if(CS2>6){LATAbits.LATA2 = 1;}
        if(CS2>8){LATAbits.LATA3 = 1;}
        if(CS2>10){LATAbits.LATA5 = 1;}
        
        if(CS3>2 && CS3< 10){LATBbits.LATB5 =1;}
        else{LATBbits.LATB5 =0;}
        
        LATD=0;
        if(CS3>2){LATDbits.LATD3 = 1;}
        if(CS3>4){LATDbits.LATD4 = 1;}
        if(CS3>6){LATDbits.LATD5 = 1;}
        if(CS3>8){LATDbits.LATD6 = 1;}
        if(CS3>10){LATDbits.LATD7 = 1;}
